...
public class Ulti : MonoBehaviour
{
    ...
    public static void MoveTo(GameObject obj, Vector3 NewPos, float duration)
    {
        ...
        obj.transform.DOLocalMove(NewPos, duration);
    ...
    public static void MoveTo(GameObject obj, Vector3 NewPos, float duration, float z)
    {
        obj.transform.DOLocalMove(new Vector3(NewPos.x, NewPos.y, z), duration);
        //        Animation anim = obj.GetComponent<Animation>();
        //        //if (anim.GetClipCount() > 1)
        //        //{
    ...
    public static void MoveTo(GameObject obj, Vector3 startpos, Vector2 NewPos, float duration, float z)
    {
